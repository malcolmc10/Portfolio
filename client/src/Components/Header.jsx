...
export default class Header extends Component {
    ...
    <a href="/"><span className="font-semibold text-xl tracking-tight mr-4 hidden sm:inline-block">Colin Malcolm</span></a>
      ...
      <a href="https://pdfhost.io/v/lSBoW0vtk_Colin_Malcolm_SWE_Resume.pdf" target="_blank" className=" font-bold  text-pink-400 hover:text-indigo-400 text-xs sm:text-base">
        Resume
      </a>
      </div>
