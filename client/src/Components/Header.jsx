...
export default class Header extends Component {
  ...
  <div class="flex font-bold flex-shrink-0 items-center text-white mr-6 " >
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div className="text-sm lg:flex-grow">
      <a href="#About" className="block flex-shrink-0 mt-4 font-bold lg:inline-block lg:mt-0 text-teal-400 hover:text-pink-400 mr-4">
        Who Am I?
      </a>
      <a href="#Title" className="block mt-4 font-bold lg:inline-block lg:mt-0 text-yellow-400 hover:text-teal-400 mr-4 ">
        Projects
      </a>
