    ...
    render() {
        return (
            <div className="my-5 mx-auto max-w-xl shadow-md bg-white py-4 rounded-l-md rounded-r-lg ">
                ...
                <p className="text-center justify-content-center text-md text-black m-8 ">
                    I am a software engineer with a background in marketing 
                    and communications. I have my Bachelors of Science in Communications from East Carolina 
                    University. I have a natural love for technology which allows me to truely love what I do. My process is a combination of a 
                    level-headed approach with an eye for detail and my team first 
                    mentality.  Every problem has multiple solutions and I am 
                    committed to building a stronger understanding through my work.</p><br></br>
